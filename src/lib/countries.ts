// Countries data for the signup form including ISO codes and phone codes
export interface Country {
    name: string;
    code: string; // ISO 3166-1 Alpha-2
    phoneCode: string; // International calling code with + prefix
...
export const COUNTRIES: Country[] = [
    ...
    {name: "East Timor", code: "TL", phoneCode: "+670", flag: "🇹🇱"},
