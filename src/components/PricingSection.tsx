            ...
            <section id="pricing" className="bg-gradient-to-b from-white to-gray-50 py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex justify-center">
                        <div
                            className="w-16 h-16 border-4 border-blinkly-blue border-t-transparent rounded-full animate-spin"></div>
                    </div>
                </div>
            </section>
        );
        ...
        <section id="pricing" className="bg-gradient-to-b from-white to-gray-50 py-20">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center justify-center mt-6 mb-12">
                    <span
                        className={`mr-3 ${!yearly ? 'font-semibold text-blinkly-blue' : 'text-gray-500'}`}>Monthly</span>
                    <Switch
                        checked={yearly}
            ...
            Yearly <span className="text-sm text-green-500 font-normal">(Save 16%)</span>
                        ...
                        {packages.map((pkg: Package) => {
                            ...
                            return (
                                ...
                                >
                                    {pkg.isMostPopular && (
                                        <div
                                            className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-blinkly-blue text-white px-4 py-1 rounded-full text-sm font-medium">
                                            Most Popular
                                        </div>
                                    )}
                ...
                <div className="mt-12 text-center">
                    <p className="text-gray-500">
                        Need a custom plan? <a href="mailto:sales@blinkly.app"
                                               className="text-blinkly-blue hover:underline">Contact our sales team</a>
                    </p>
                </div>
            </div>
        </section>
