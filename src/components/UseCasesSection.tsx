  ...
  return (
    <section id="use-cases" className="bg-gray-50 py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row md:gap-8 md:overflow-x-auto md:snap-x md:snap-mandatory md:pb-6 max-w-7xl mx-auto">
          {useCases.map((useCase) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Button variant="ghost" className="text-blinkly-blue hover:text-blinkly-violet hover:bg-blue-50 px-0">
