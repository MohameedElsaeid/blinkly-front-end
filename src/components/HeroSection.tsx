...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen pt-20 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-10 md:left-1/3 w-12 h-12 animate-float" style={{animationDelay: '1s'}}>
      ...
      {/* Main Content */}
      <div className="container relative z-10 mx-auto px-4 pt-24 md:pt-32 flex flex-col items-center justify-center">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="glass-card bg-white/40 p-6 max-w-2xl mx-auto mb-16">
            <form onSubmit={handleShortenUrl} className="flex flex-col sm:flex-row gap-3">
              ...
              <Button type="submit" className="h-12 bg-blinkly-blue hover:bg-blinkly-violet text-white font-medium px-6">
                Shorten Now
              </Button>
            </form>
